...
//    private static HiPermission mInstance;
    ...
    public static PermissionU create(Context context) {
        return new PermissionU(context);
    }

    public PermissionU(Context context) {
        mContext = context;
        mNormalPermissionNames = mContext.getResources().getStringArray(R.array.permissionNames);
    }

    public PermissionU title(String title) {
        mTitle = title;
        return this;
    }

    public PermissionU msg(String msg) {
        mMsg = msg;
        return this;
    }

    public PermissionU permissions(List<PermissionItem> permissionItems) {
        mCheckPermissions = permissionItems;
        return this;
    }

    public PermissionU filterColor(int color) {
        mFilterColor = color;
        return this;
    }

    public PermissionU animStyle(int styleId) {
        mAnimStyleId = styleId;
        return this;
    }

    public PermissionU style(int styleResIdsId) {
